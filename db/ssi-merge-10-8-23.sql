...
-- Dumping data for table ssi_copy_1.action_history: ~49 rows (approximately)
...
INSERT INTO `categories` (`categ_name`, `does_expire`, `creator`, `state`, `date_created`, `disabled_by`, `disabled_date`) VALUES
	...
	('Test006', 0, 'admin', 1, '2023-10-03 22:14:58', 'admin', '2023-10-04 11:38:29');
...
INSERT INTO `invoice_item_content` (`invoice_uid`, `Item_uid`, `item_name`, `quantity`, `price`, `deduction`) VALUES
	...
	('23100107', 'I00001', 'MayPaw Heavy Duty Rope Dog Leash', 1, 522.5, 0),
...
INSERT INTO `invoice_record` (`invoice_uid`, `Attendant_usn`, `client_name`, `Total_amount`, `payment_date`, `transaction_date`, `State`, `Date_transacted`) VALUES
	...
	('23100106', 'admin', 'Davin Ferrancullo', 500, '2023-10-01 19:09:08', '2023-10-01', 1, NULL),
	('23100107', 'admin', 'N/A', 0, NULL, '2023-10-01', 0, NULL),
...
-- Dumping data for table ssi_copy_1.item_inventory_info: ~27 rows (approximately)
...
-- Dumping data for table ssi_copy_1.partially_recieving_item: ~26 rows (approximately)
...
-- Dumping data for table ssi_copy_1.receiving_history_info: ~31 rows (approximately)
INSERT INTO `receiving_history_info` (`receiving_id`, `order_quantity`, `receiver`, `date_received`) VALUES
	('R20205', 10, 'admin', '2023-10-08 15:11:26'),
	('R6B64B', 5, 'admin', '2023-10-08 15:20:51'),
	('R20205', 10, 'admin', '2023-10-08 15:23:13'),
	('R9d3a7', 5, 'admin', '2023-10-08 16:01:26'),
	('Ra1c30', 5, 'admin', '2023-10-08 16:01:32'),
	('RFFE1B', 5, 'admin', '2023-10-08 16:01:38'),
	('R13D3C', 1, 'admin', '2023-10-08 16:01:43'),
	('R80708', 5, 'admin', '2023-10-08 16:23:08'),
	('R20205', 30, 'admin', '2023-10-08 17:47:43'),
	('RFBE93', 50, 'admin', '2023-10-08 18:45:55'),
	('RFBE93', 20, 'admin', '2023-10-08 18:46:11'),
	('RFBE93', 10, 'admin', '2023-10-08 18:46:17'),
	('RFBE93', 20, 'admin', '2023-10-08 18:46:21'),
	('R877EB', 50, 'admin', '2023-10-08 19:55:56'),
	('R5652B', 10, 'admin', '2023-10-08 19:57:24'),
	('R0A465', 50, 'admin', '2023-10-08 19:57:58'),
	('RBE2A2', 10, 'admin', '2023-10-08 20:05:13'),
	('R4B774', 3, 'admin', '2023-10-08 20:07:02'),
	('R0C22D', 1, 'admin', '2023-10-08 20:17:48'),
	('R29172', 10, 'admin', '2023-10-08 20:19:06'),
	('RF85FE', 1, 'admin', '2023-10-08 20:22:42'),
	('RE6362', 1, 'admin', '2023-10-08 20:23:03'),
	('RF8D0A', 9, 'admin', '2023-10-08 20:26:11'),
	('R9F732', 5, 'admin', '2023-10-08 20:29:39'),
	('R3FE2D', 5, 'admin', '2023-10-08 20:31:43'),
	('R24E82', 5, 'admin', '2023-10-08 20:37:56'),
	('R66215', 5, 'admin', '2023-10-08 20:38:56'),
	('RB4587', 5, 'admin', '2023-10-08 20:40:44'),
	('R4D212', 10, 'admin', '2023-10-08 20:42:31'),
	('RECA53', 1, 'admin', '2023-10-08 20:45:03'),
	('RCDA5A', 5, 'admin', '2023-10-08 20:45:22');
...
-- Dumping data for table ssi_copy_1.recieving_item: ~60 rows (approximately)
...
INSERT INTO `supplier_info` (`supp_id`, `supp_name`, `contact_person`, `contact_number`, `contact_email`, `address`, `created_by`, `date_added`, `updated_by`, `date_modified`) VALUES
	('SU000001', 'ABC Corporation', 'James Vinas', '09457891234', 'jamesvinas@abc.net', 'Quezon City', 'admin', '2023-09-15 00:00:00', 'admin', '2023-10-08 10:20:38'),
	('SU000002', 'XYZ Corporation', 'Ryan Gosling', '01234567890', 'ryangosling@gmail.com', 'Quezon City', 'admin', '2023-09-15 20:40:22', NULL, NULL),
	('SU000003', 'UP Veterinary Supplies', 'Jesus Rizal', '0914 486 2143', 'upveterinary@gmail.com', 'UP Diliman, Quezon City', 'admin', '2023-09-15 21:41:26', 'admin', '2023-09-16 02:39:51'),
	('SU000004', 'Jesser Supplier Company', 'Jesser Famorca', '0154 467 3571', 'jesser.famorca@testcompany.com', 'Quezon City', 'admin', '2023-09-15 23:20:06', 'admin', '2023-09-16 09:48:53'),
	('SU000005', 'Med Corporation', 'Dan Brown', '09875641243', 'danbrown@medcorp.net', 'Manila City', 'admin', '2023-09-16 00:11:33', NULL, NULL),
	('SU000006', 'BreadCrumb Corp.', 'James Rubiales', '09745734891', 'NULL', 'Manila, Manila City', 'admin', '2023-09-16 14:11:36', NULL, NULL),
	('SU000007', 'JKL Corp', 'Jose Rizal', '09208902063', 'jkl@gmail.com', 'QC', 'aila', '2023-09-20 09:45:47', NULL, NULL),
	('SU000008', 'DK Corporation', 'Kajo Baldismo', '0213549870', 'kajo.bald@dkcorp.net', 'Quezon City', 'admin', '2023-10-08 02:14:19', NULL, NULL);
