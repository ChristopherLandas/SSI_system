...
def new_customer(master, info:tuple, command_callback: callable = None):
    class instance(ctk.CTkFrame):
        def __init__(self, master, info:tuple, command_callback: callable):
            ...
            self.customer_num_entry = ctk.CTkEntry(self.customer_frame, placeholder_text="Contact Number",font=("DM Sans Medium", 14), placeholder_text_color="grey", border_width=2, fg_color=Color.White_Lotion)
            ...
            self.customer_address_entry = ctk.CTkEntry(self.customer_frame, placeholder_text="Customer Name",font=("DM Sans Medium", 14), placeholder_text_color="grey", border_width=2, fg_color=Color.White_Lotion)
