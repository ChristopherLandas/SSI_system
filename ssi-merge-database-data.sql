...
-- Dumping data for table ssi_merged.account_access_level: ~8 rows (approximately)
...
INSERT INTO `item_inventory_info` (`id`, `UID`, `Stock`, `Expiry_Date`, `state`, `added_date`) VALUES
	(56, 'I00002', 46, NULL, 1, '2023-10-29'),
	(58, 'I00004', 42, NULL, 1, '2023-10-29'),
	(59, 'I00005', 132, '2023-10-26', -1, '2023-10-29'),
	(60, 'I00005', 43, '2023-08-31', -1, '2023-10-29'),
	(61, 'I00006', 190, NULL, 1, '2023-10-29'),
	(62, 'I00005', 8, NULL, 1, '2023-10-29'),
	(63, 'I00005', 0, NULL, 1, '2023-10-29'),
	(64, 'I00005', 33, NULL, 1, '2023-10-29'),
	...
	(72, 'I1aa81', 160, NULL, 1, '2023-10-29'),
	(73, 'Ia71e7', 107, NULL, 1, '2023-10-29'),
	(74, 'I2b993', 110, NULL, 1, '2023-10-29'),
	(75, 'Iaad08', 75, NULL, 1, '2023-10-29'),
	(76, 'I39DC8', 20, NULL, 1, '2023-10-29'),
	(77, 'I0AE71', 40, NULL, 1, '2023-10-29'),
	(78, 'I7A986', 10, NULL, 1, '2023-10-29'),
	(79, 'IFF357', 30, NULL, 1, '2023-10-29'),
	(80, 'IACBE3', 10, NULL, 1, '2023-10-29'),
	...
	(97, 'I1F3E7', 4, NULL, 1, '2023-10-29'),
	(98, 'IED7B0', 5, NULL, 1, '2023-10-29'),
	(99, 'I8EC1F', 0, NULL, 1, '2023-10-29'),
	(100, 'I2F75F', 0, NULL, 1, '2023-10-29'),
	(101, 'I79FD7', 0, NULL, 1, '2023-10-29'),
	(102, 'I3128E', 1, NULL, 1, '2023-10-29'),
	(103, 'I1F3E7', 5, NULL, 1, '2023-10-29'),
	(104, 'IE273F', 8, NULL, 1, '2023-11-03');
...
INSERT INTO `recieving_item` (`id`, `NAME`, `item_uid`, `ordered_by`, `initial_stock`, `current_stock`, `supp_id`, `exp_date`, `reciever`, `state`, `date_set`, `date_recieved`) VALUES
	...
	('R6E644', 'TESTB', 'I2F75F', 'admin', 10, 10, 'SU000001', NULL, NULL, 1, '2023-10-29 21:45:30', NULL),
...
-- Dumping data for table ssi_merged.transaction_record: ~165 rows (approximately)
INSERT INTO `transaction_record` (`transaction_uid`, `Attendant_usn`, `client_name`, `Total_amount`, `transaction_date`, `state`) VALUES
	('0', 'aila', 'N/A', 1045, '2023-07-14', 1),
	('1', 'aila', 'James V.', 500, '2023-07-15', 1),
	('10', 'aila', 'Jose R.', 500, '2023-08-01', 1),
	('100', 'admin', 'Davin Ferrancullo', 1000, '2023-10-18', 1),
	('101', 'admin', 'Joze Rizal', 7837.5, '2023-10-18', 1),
	('102', 'admin', 'Joze Rizal', 505, '2023-10-18', 1),
	('103', 'admin', 'James Viñas', 288, '2023-10-27', 1),
	('104', 'aila', 'Patrick Feniza', 2612.5, '2023-10-27', 1),
	('105', 'aila', 'Patrick Feniza', 2612.5, '2023-10-27', 1),
	('106', 'aila', 'Patrick Feniza', 2612.5, '2023-10-27', 1),
	('107', 'aila', 'Patrick Feniza', 2612.5, '2023-10-27', 1),
	('108', 'aila', 'Patrick Feniza', 2612.5, '2023-10-27', 1),
	('109', 'aila', 'Patrick Feniza', 2612.5, '2023-10-27', 1),
	('11', 'aila', 'N/A', 440, '2023-08-06', 1),
	('110', 'aila', 'Joze Rizal', 2200, '2023-10-27', 1),
	('111', 'aila', 'N/A', 2612.5, '2023-10-27', 1),
	('112', 'aila', 'N/A', 2200, '2023-10-27', 1),
	('113', 'aila', 'N/A', 2612.5, '2023-10-27', 1),
	('114', 'aila', 'Joze Rizal', 500, '2023-10-27', 1),
	('115', 'aila', 'N/A', 2200, '2023-10-27', 1),
	('116', 'aila', 'N/A', 2887.5, '2023-10-27', 1),
	('117', 'aila', 'N/A', 577.5, '2023-10-27', 1),
	('118', 'aila', 'N/A', 3984.75, '2023-10-27', 1),
	('119', 'admin', 'N/A', 2200, '2023-10-27', 1),
	('12', 'aila', 'James V.', 900, '2023-08-06', 1),
	('120', 'admin', 'Christopher Landas', 1320, '2023-10-27', 1),
	('121', 'admin', 'Budjette Tan', 2280.3, '2023-10-27', 1),
	('122', 'admin', 'James Viñas', 23567.5, '2023-10-27', 1),
	('123', 'admin', 'N/A', 2750, '2023-10-30', 1),
	('124', 'admin', 'N/A', 550, '2023-10-30', 1),
	('125', 'admin', 'N/A', 560, '2023-10-30', 1),
	('126', 'admin', 'N/A', 550, '2023-10-30', 1),
	('127', 'admin', 'N/A', 254, '2023-10-30', 1),
	('128', 'admin', 'N/A', 1580.15, '2023-10-30', 1),
	('129', 'admin', 'N/A', 110, '2023-10-30', 1),
	('13', 'aila', 'James V.', 500, '2023-08-07', 1),
	('130', 'admin', 'N/A', 440, '2023-10-30', 1),
	('131', 'admin', 'N/A', 1100, '2023-10-30', 1),
	('132', 'admin', 'N/A', 440, '2023-10-30', 1),
	('133', 'admin', 'N/A', 940.95, '2023-10-30', 1),
	('134', 'admin', 'N/A', 440, '2023-10-30', 1),
	('135', 'admin', 'N/A', 522.5, '2023-10-30', 1),
	('136', 'admin', 'N/A', 522.5, '2023-10-30', 1),
	('137', 'admin', 'N/A', 440, '2023-10-30', 1),
	('138', 'admin', 'N/A', 440, '2023-10-30', 1),
	('139', 'admin', 'N/A', 440, '2023-10-30', 1),
	('14', 'aila', 'N/A', 1320, '2023-08-07', 1),
	('140', 'admin', 'N/A', 242.42, '2023-10-30', 1),
	('141', 'admin', 'N/A', 576, '2023-10-30', 1),
	('142', 'admin', 'N/A', 840, '2023-10-30', 1),
	('143', 'admin', 'N/A', 930, '2023-10-30', 1),
	('144', 'admin', 'N/A', 2887.5, '2023-10-30', 1),
	('145', 'admin', 'Joze Rizal', 550, '2023-10-30', 1),
	('146', 'admin', 'Client Name', 2200, '2023-10-30', 1),
	('147', 'admin', 'Client Name', 2612.5, '2023-10-30', 1),
	('148', 'admin', 'Client Name', 1240, '2023-10-30', 1),
	('149', 'admin', 'Client Name', 2181.78, '2023-10-30', 1),
	('15', 'aila', 'N/A', 880, '2023-08-14', 1),
	('150', 'admin', 'James Viñas', 1270, '2023-11-01', 1),
	('151', 'admin', 'James Viñas', 1055, '2023-11-01', 1),
	('152', 'admin', 'Patrick Feniza', 254, '2023-11-01', 1),
	('153', 'admin', 'Patrick Feniza', 310, '2023-11-02', 1),
	('154', 'admin', 'Joze Rizal', 906, '2023-11-02', 1),
	('155', 'admin', 'Client Name', 800, '2023-11-02', 1),
	('156', 'admin', 'Davin Ferrancullo', 550, '2023-11-03', 1),
	('157', 'admin', 'Client Name', 1031.6, '2023-11-03', 1),
	('158', 'admin', 'Client Name', 1284.34, '2023-11-06', 2),
	('159', 'admin', 'Client Name', 800, '2023-11-04', 1),
	('16', 'aila', 'N/A', 2033.9, '2023-08-14', 1),
	('160', 'admin', 'Client Name', 2390.85, '2023-11-05', 1),
	('161', 'admin', 'Patrick Feniza', 2200, '2023-11-05', 1),
	('162', 'admin', 'Client Name', 2200, '2023-11-05', 1),
	('163', 'admin', 'Client Name', 920, '2023-11-05', 1),
	('164', 'admin', 'Client Name', 598, '2023-11-05', 1),
	('165', 'admin', 'Client Name', 796.95, '2023-11-06', 1),
	('17', 'aila', 'James V.', 1380, '2023-08-20', 1),
	('18', 'aila', 'James V.', 500, '2023-08-20', 1),
	('19', 'aila', 'N/A', 880, '2023-08-20', 1),
	('2', 'aila', 'N/A', 440, '2023-07-15', 1),
	('20', 'aila', 'James V.', 1500, '2023-08-20', 1),
	('21', 'aila', 'James V.', 500, '2023-08-22', 1),
	('22', 'aila', 'Davin F.', 500, '2023-08-22', 1),
	('23', 'aila', 'N/A', 440, '2023-08-22', 1),
	('24', 'aila', 'N/A', 2200, '2023-08-22', 1),
	('25', 'aila', 'N/A', 440, '2023-08-22', 1),
	('26', 'aila', 'N/A', 440, '2023-08-22', 1),
	('27', 'aila', 'N/A', 440, '2023-08-22', 1),
	('28', 'aila', 'N/A', 1320, '2023-08-22', 1),
	('29', 'aila', 'N/A', 440, '2023-08-22', 1),
	('3', 'aila', 'N/A', 3420.45, '2023-07-16', 1),
	('30', 'aila', 'N/A', 1320, '2023-08-22', 1),
	('31', 'aila', 'N/A', 440, '2023-08-22', 1),
	('32', 'aila', 'N/A', 1760, '2023-08-23', 1),
	('33', 'aila', 'Jose R.', 440, '2023-08-23', 1),
	('34', 'aila', 'N/A', 796.95, '2023-08-23', 1),
	('35', 'aila', 'James V.', 2280.3, '2023-08-26', 1),
	('36', 'aila', 'N/A', 2310, '2023-08-28', 1),
	('37', 'aila', 'N/A', 2171.4, '2023-08-28', 1),
	('38', 'aila', 'Jose R.', 0, '2023-08-28', 1),
	('39', 'aila', 'N/A', 577.5, '2023-08-29', 1),
	('4', 'aila', 'James V.', 500, '2023-07-16', 1),
	('41', 'aila', 'Bud Tan', 1500, '2023-08-29', 1),
	('42', 'aila', 'James V.', 500, '2023-08-29', 1),
	('43', 'aila', 'Bud Tan', 500, '2023-08-29', 1),
	('44', 'aila', 'Bud Tan', 500, '2023-08-30', 1),
	('45', 'aila', 'James V.', 500, '2023-08-30', 1),
	('46', 'aila', 'N/A', 577.5, '2023-08-30', 1),
	('47', 'aila', 'N/A', 577.5, '2023-08-30', 1),
	('48', 'aila', 'Christopher L.', 2310, '2023-08-30', 1),
	('49', 'admin', 'N/A', 522.5, '2023-08-30', 1),
	('5', 'aila', 'Jose R.', 1000, '2023-07-16', 1),
	('50', 'admin', 'James V.', 1567.5, '2023-08-30', 1),
	('51', 'admin', 'N/A', 577.5, '2023-08-30', 1),
	('52', 'admin', 'Bud Tan', 1567.5, '2023-08-31', 1),
	('53', 'admin', 'N/A', 1045, '2023-08-31', 1),
	('54', 'admin', 'N/A', 1155, '2023-08-31', 1),
	('55', 'admin', 'N/A', 522.5, '2023-08-31', 1),
	('56', 'admin', 'N/A', 522.5, '2023-08-31', 1),
	('57', 'admin', 'N/A', 522.5, '2023-08-31', 1),
	('58', 'admin', 'N/A', 1567.5, '2023-08-31', 1),
	('59', 'admin', 'N/A', 522.5, '2023-09-02', 1),
	('6', 'aila', 'N/A', 3187.8, '2023-07-13', 1),
	('60', 'admin', 'James V.', 2780.3, '2023-09-02', 1),
	('61', 'admin', 'Bud Tan', 500, '2023-09-02', 1),
	('62', 'admin', 'Patrick Feniza', 500, '2023-09-02', 1),
	('63', 'admin', 'James V.', 1000, '2023-09-03', 1),
	('64', 'admin', 'Davin F.', 2500, '2023-09-03', 1),
	('65', 'admin', 'Jose R.', 1000, '2023-09-03', 1),
	('66', 'admin', 'James V.', 500, '2023-09-03', 1),
	('67', 'admin', 'Patrick Feniza', 500, '2023-09-03', 1),
	('68', 'admin', 'Bud Tan', 500, '2023-09-03', 1),
	('69', 'admin', 'Patrick Feniza', 500, '2023-09-03', 1),
	('7', 'aila', 'Jose R.', 1000, '2023-07-13', 1),
	('70', 'admin', 'James V.', 3000, '2023-09-03', 1),
	('71', 'admin', 'Patrick Feniza', 2500, '2023-09-03', 1),
	('72', 'admin', 'Davin F.', 4600, '2023-09-03', 1),
	('73', 'admin', 'James V.', 2100, '2023-09-03', 1),
	('74', 'admin', 'Patrick Feniza', 2000, '2023-09-03', 1),
	('75', 'admin', 'N/A', 2280.3, '2023-09-03', 1),
	('76', 'admin', 'N/A', 2280.3, '2023-09-03', 1),
	('77', 'admin', 'N/A', 288, '2023-09-03', 1),
	('78', 'Jrizal', 'Christopher L.', 2500, '2023-09-03', 1),
	('79', 'admin', 'James Viñas', 4500, '2023-09-07', 1),
	('8', 'aila', 'N/A', 1593.9, '2023-08-01', 1),
	('80', 'admin', 'Davin Ferrancullo', 500, '2023-09-29', 1),
	('81', 'admin', 'Patrick Feniza', 2200, '2023-09-29', 1),
	('82', 'admin', 'N/A', 0, '2023-09-29', 1),
	('83', 'admin', 'Patrick Feniza', 500, '2023-10-01', 1),
	('84', 'admin', 'N/A', 0, '2023-10-01', 1),
	('85', 'admin', 'N/A', 0, '2023-10-01', 1),
	('86', 'admin', 'N/A', 0, '2023-10-01', 1),
	('87', 'admin', 'N/A', 0, '2023-10-01', 1),
	('88', 'admin', 'N/A', 0, '2023-10-01', 1),
	('89', 'admin', 'Budjette Tan', 500, '2023-10-01', 1),
	('9', 'aila', 'N/A', 144, '2023-08-01', 1),
	('90', 'admin', 'N/A', 505, '2023-10-12', 1),
	('91', 'admin', 'N/A', 10100, '2023-10-12', 1),
	('92', 'admin', 'N/A', 2151.5, '2023-10-17', 1),
	('93', 'admin', 'Davin Ferrancullo', 2475, '2023-10-17', 1),
	('94', 'admin', 'N/A', 0, '2023-10-17', 1),
	('95', 'admin', 'N/A', 0, '2023-10-17', 1),
	('96', 'admin', 'Patrick Feniza', 440, '2023-10-18', 1),
	('97', 'admin', 'Joze Rizal', 1140.15, '2023-10-18', 1),
	('98', 'admin', 'James Viñas', 440, '2023-10-18', 1),
	('99', 'admin', 'James Rubiales', 577.5, '2023-10-18', 1);
