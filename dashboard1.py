...
class reports_frame(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        def generate_report():
            ...
            if 'Yearly' in self.report_option_var.get():
                ...
                bc.categoryAxis.categoryNames = yearly_label
                #legends
                ...
                for i in range(0, monthlength):
                    ...
                    yearly_report_temp_data.append(yearly_label[i])
    ...
    def show_bar(self, master, data_service, data_item, info=[], label=[]):
        ...
        _label = label
        _data_service = data_service
        _data_item = data_item if not None in data_item else [0 for _ in range(data_item)]
