...
-- Dumping data for table ssi_merged.invoice_record: ~191 rows (approximately)
INSERT INTO `invoice_record` (`invoice_uid`, `Attendant_usn`, `client_name`, `Total_amount`, `payment_date`, `transaction_date`, `State`, `Date_transacted`, `process_type`) VALUES
	...
	('23102712', 'admin', 'James Viñas', 23567.5, '2023-10-27 12:23:18', '2023-10-27', 2, '2023-10-27', 0),
	...
	('23110103', 'admin', 'Patrick Feniza', 500, '2023-11-12 19:54:08', '2023-11-01', 2, '2023-11-12', 1),
	...
	('23110502', 'admin', 'Patrick Feniza', 500, '2023-11-12 19:54:12', '2023-11-05', 2, '2023-11-12', 1),
	...
	('23111100', 'admin', 'Client Name', 242.42, '2023-11-11 12:20:25', '2023-11-11', 2, '2023-11-11', 0),
	('23111101', 'admin', 'Client Name', 242.42, '2023-11-11 12:26:01', '2023-11-11', 2, '2023-11-11', 0),
	('23111200', 'admin', 'Client Name', 310, '2023-11-12 13:33:25', '2023-11-12', 2, '2023-11-12', 0),
	('23111201', 'admin', 'Client Name', 144, '2023-11-12 13:49:16', '2023-11-12', 2, '2023-11-12', 0),
	('23111202', 'admin', 'Patrick Feniza', 720, '2023-11-12 18:11:47', '2023-11-12', 2, '2023-11-12', 0),
	('23111203', 'admin', 'James Viñas', 440, '2023-11-12 18:15:04', '2023-11-12', 2, '2023-11-12', 0),
	('23111204', 'admin', 'James Viñas', 2500, '2023-11-12 21:30:33', '2023-11-12', 1, NULL, 1),
	('23111205', 'admin', 'TEST12', 242.42, '2023-11-12 18:17:27', '2023-11-12', 2, '2023-11-12', 0),
	('23111206', 'admin', 'Budjette Tan', 1140.15, '2023-11-12 18:27:17', '2023-11-12', 2, '2023-11-12', 0),
	('23111207', 'admin', 'TEST12', 144, '2023-11-12 20:27:59', '2023-11-12', 2, '2023-11-12', 0),
	('23111208', 'admin', 'Client Name', 144, '2023-11-12 20:30:55', '2023-11-12', 2, '2023-11-12', 0),
	('23111209', 'admin', 'Joze Rizal', 432, '2023-11-12 20:41:13', '2023-11-12', 2, '2023-11-12', 0),
	('23111210', 'admin', 'Client Name', 1140.15, '2023-11-12 20:48:22', '2023-11-12', 2, '2023-11-12', 0),
	('23111211', 'admin', 'Client Name', 3420.45, '2023-11-12 21:03:11', '2023-11-12', 2, '2023-11-12', 0),
	('23111212', 'admin', 'TEST12', 800, '2023-11-12 21:15:02', '2023-11-12', 2, '2023-11-12', 0),
	('23111213', 'admin', 'James Viñas', 500, '2023-11-12 21:30:31', '2023-11-12', 2, '2023-11-12', 1),
	('23111400', 'admin', 'James Viñas', 288, '2023-11-14 11:12:19', '2023-11-14', 2, '2023-11-14', 0),
	('23111401', 'admin', 'James Viñas', 500, '2023-11-14 11:13:58', '2023-11-14', 2, '2023-11-14', 1),
...
INSERT INTO `item_inventory_info` (`id`, `UID`, `Stock`, `Expiry_Date`, `state`, `added_date`) VALUES
	...
	(74, 'I2b993', 106, NULL, 1, '2023-10-29'),
	...
	(107, 'I2F75F', 8, NULL, 1, '2023-11-10'),
...
-- Dumping data for table ssi_merged.item_settings: ~26 rows (approximately)
...
-- Dumping data for table ssi_merged.item_statistic_info: ~24 rows (approximately)
...
-- Dumping data for table ssi_merged.item_transaction_content: ~169 rows (approximately)
...
-- Dumping data for table ssi_merged.partially_recieving_item: ~38 rows (approximately)
...
-- Dumping data for table ssi_merged.pet_breed: ~6 rows (approximately)
...
-- Dumping data for table ssi_merged.pet_info: ~26 rows (approximately)
...
-- Dumping data for table ssi_merged.pet_owner_info: ~15 rows (approximately)
INSERT INTO `pet_owner_info` (`owner_id`, `owner_name`, `address`, `contact_number`, `added_by`, `date_added`, `updated_by`, `updated_date`) VALUES
	('1', 'Patrick Feniza', 'Diliman, Quezon City', '09874561234', 'admin', '2023-11-15 23:35:03', NULL, NULL),
	...
	('28', 'James Rubiales', 'Tet1', 'Tset', 'admin', '2023-11-15 23:35:07', NULL, NULL),
	...
	('4', 'Christopher Landas', 'Rodriguez. Rizal ', '09076208927', 'admin', '2023-11-15 23:35:05', NULL, NULL),
	('5', 'James Viñas', 'Tala, Caloocan City', '09208902063', 'admin', '2023-11-15 23:35:05', NULL, NULL),
	('6', 'Budjette Tan', 'Trese, Manila City', '09123456789', 'admin', '2023-11-15 23:35:06', NULL, NULL),
	('C636CA', 'Testing13', '2061650684', 'Testing13', 'admin', '2023-11-16 00:22:58', NULL, NULL),
	('CF9E35C3', 'James Testing', 'Testing', '0920 890 2063', 'admin', '2023-11-16 00:39:02', NULL, NULL);
...
INSERT INTO `recieving_item` (`id`, `NAME`, `item_uid`, `ordered_by`, `initial_stock`, `current_stock`, `supp_id`, `exp_date`, `reciever`, `state`, `date_set`, `date_recieved`) VALUES
	...
	('RF6EC1', '1000 (100mg)', 'I1F3E7', 'admin', 10, 5, 'SU000001', NULL, 'admin', 3, '2023-10-29 19:33:38', '2023-10-29 19:33:48'),
...
-- Dumping data for table ssi_merged.services_transaction_content: ~0 rows (approximately)
INSERT INTO `services_transaction_content` (`transaction_uid`, `service_uid`, `service_name`, `pet_uid`, `patient_name`, `scheduled_date`, `price`, `deduction`, `status`, `end_schedule`, `multiple_sched_quan`, `instance_of_mul_sched`, `service_provider`) VALUES
	('181', 'S00001', 'Grooming', '234729', 'Miru', '2023-11-14', 500, 0, 0, NULL, NULL, NULL, NULL);
...
INSERT INTO `service_info_test` (`UID`, `service_name`, `price`, `category`, `duration_type`, `state`, `date_added`) VALUES
	...
	('S5cf5d', 'Grooming Large', 700, '', 0, 1, '2023-11-12'),
	('S86AD1', 'Grooming (Medium)', 500, NULL, 0, 1, '2023-11-13'),
	('Saecf2', 'Grooming (Large)', 600, NULL, 0, 1, '2023-11-13'),
	('Se7c43', 'Canine Diagnostic', 1200, '', 0, 1, '2023-08-31');

-- Dumping data for table ssi_merged.service_preceeding_schedule: ~0 rows (approximately)

-- Dumping data for table ssi_merged.supplier_info: ~12 rows (approximately)
...
-- Dumping data for table ssi_merged.supplier_item_info: ~48 rows (approximately)
